...
public class RecadoDao extends ConexaoHSQLDB {
	...
	final String SQL_SELECT_RECADO_NOME = "SELECT * FROM RECADO WHERE NOME LIKE ?";
	...
	final String SQL_SELECT_RECADO_LAST_INSERT = "SELECT * FROM RECADO WHERE ID = (SELECT MAX(ID) FROM RECADO)";

	public Recado ultimoCadastro() {
		Recado recado = new Recado();
		try (Connection connection = this.conectar();
				PreparedStatement pst = connection.prepareStatement(SQL_SELECT_RECADO_LAST_INSERT);) {
...
//LISTAR
	...
	public List<Recado> listAllName(String nome) {
		List<Recado> listaRecado = new ArrayList<>();

		try (Connection connection = this.conectar();
				PreparedStatement pst = connection.prepareStatement(SQL_SELECT_RECADO_NOME);) {
