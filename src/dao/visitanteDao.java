...
public class visitanteDao extends ConexaoHSQLDB {
	...
	final String SQL_SELECT_VISITANTE_NOME = "SELECT * FROM VISITANTE WHERE NOME LIKE ?";
	...
	final String SQL_SELECT_VISITANTE_LAST_INSERT = "SELECT * FROM VISITANTE WHERE ID = (SELECT MAX(ID) FROM VISITANTE)";

	public Visitante ultimoCadastro() {
		Visitante visitante = new Visitante();
		try (Connection connection = this.conectar();
				PreparedStatement pst = connection.prepareStatement(SQL_SELECT_VISITANTE_LAST_INSERT);) {
	...
	public List<Visitante> listAllName(String nome) {
		List<Visitante> listaVisitante = new ArrayList<Visitante>();

		try (Connection connection = this.conectar();
				PreparedStatement pst = connection.prepareStatement(SQL_SELECT_VISITANTE_NOME);) {
